<html>
    ...
    <body>
		...
		<?php
           if(isset($_POST["btn"]))
           {
	        $con=mysqli_connect("localhost","root","Admin123","grocerydb");
		if(!$con)
		{
		die("cannot connect to server");
               ...
               $q="insert into grocerytb(id,Item_name,Item_Quantity,Item_status,Date)values(100,'$item_name',$item_qty,'$item_status','$date')";
